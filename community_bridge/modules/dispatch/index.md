...
- [Client Functions](./client) - Client-side dispatch interfaces and emergency calling
- [Server Functions](./server) - Server-side incident management and coordination
- [Shared Functions](./shared) - Shared utilities and data structures
